...
namespace Konditerka
{
    public partial class managClient_form : Form
    {
        ...
        {
            //Удаление строк записей из таблицы Заказы
        ...
        //Изменение статуса заказа при нажатие
        private void dataGridView3_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            { 
                //Изменение статуса заказа в зависимости от предыдущего статуса
                switch (dataGridView3.CurrentCell.Value)
                {
                    case "Новый":
                        ...
                        cmd.ExecuteNonQuery();
                        //Изменение отображения в таблице
                    ...
                    case "Ожидает":
                        ...
                        break;
                    case "Обработка":
                        //Доп вопрос на изменение статуса
